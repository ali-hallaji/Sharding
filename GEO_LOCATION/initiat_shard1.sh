...
config = { _id: "shard1_1", members:[
          { _id : 0, host : "shard1:37017" },
          { _id : 1, host : "shard1:37018" },
          { _id : 2, host : "shard1:37019" }]};
rs.initiate(config)
EOF
...
config = { _id: "shard1_2", members:[
          { _id : 0, host : "shard1:47017" },
          { _id : 1, host : "shard1:47018" },
          { _id : 2, host : "shard1:47019" }]};
rs.initiate(config)
EOF
...
config = { _id: "shard1_3", members:[
          { _id : 0, host : "shard1:57017" },
          { _id : 1, host : "shard1:57018" },
          { _id : 2, host : "shard1:57019" }]};
rs.initiate(config)
EOF
